...
public class ExcelUtil<T> {
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = SpringContextHolder.getBean(GunsProperties.class).getFileUploadMapping() + filename;
    ...
    public static void main(String[] args) {
        System.out.println(SpringContextHolder.getBean(GunsProperties.class).getFileUploadMapping() + "用户数据");
    }
